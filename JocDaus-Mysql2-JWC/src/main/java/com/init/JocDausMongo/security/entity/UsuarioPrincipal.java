...
public class UsuarioPrincipal implements UserDetails {
    ...
    public static UsuarioPrincipal build(Usuario usuario){//per estaablir els privilegis dels usuaris
        List<GrantedAuthority> authorities =
                usuario.getRoles().stream().map(rol -> new SimpleGrantedAuthority(rol //estem convertint la classe rol en la classe GrantedAuthoriy
